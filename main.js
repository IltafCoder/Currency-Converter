...
const fetchCurrency = async () => {
    ...
    const response = await fetch("https://v6.exchangerate-api.com/v6/65cd13a39535c5526138cea0/latest/USD")
...
const convertCurrency = async () => {
    ...
    const response = await fetch(`https://v6.exchangerate-api.com/v6/65cd13a39535c5526138cea0/pair/${from_currency}/${to_currency}/${amount}`)
    const data = await response.json()
    // calulate the result
